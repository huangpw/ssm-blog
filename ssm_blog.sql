...
CREATE TABLE `t_article`  (
  ...
  `create_time` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '发布时间',
  `update_time` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '更新时间',
  `is_hot` int(255) DEFAULT NULL COMMENT '是否热门 0：不热门 1：热门',
  `logo` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '文章logo',
  `uid` int(11) DEFAULT NULL COMMENT '发布者',
  `isOpen` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '是否公开 0:不公开 1:公开',
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '合作伙伴' ROW_FORMAT = Compact;
...
CREATE TABLE `t_user`  (
  ...
  `createTime` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '创建时间',
  `lastLoginTime` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '登录时间',
