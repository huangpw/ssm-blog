...
<head>
<meta charset="utf-8">
<title>文章 - HUANGPW博客管理后台</title>
<link rel="stylesheet" type="text/css" href="/ssm-blog/bootstrap-3.3.7-dist/css/bootstrap.min.css">
...
<%--layui--%>
<link href="/ssm-blog/layui/css/layui.css" rel="stylesheet" type="text/css" />
<script src="/ssm-blog/js/jquery/jquery-2.1.1.min.js"></script>

<script src="/ssm-blog/layui/layui.js" type="text/javascript"></script>

<%--导入分页插件--%>
<link href="/ssm-blog/js/jquery/bs_pagination/jquery.bs_pagination.min.css" type="text/css" rel="stylesheet" />
<script type="text/javascript" src="/ssm-blog/js/jquery/bs_pagination/en.js"></script>
<script type="text/javascript" src="/ssm-blog/js/jquery/bs_pagination/jquery.bs_pagination.min.js"></script>
</head>
  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      <ul class="nav nav-sidebar">
        <li><a href="/ssm-blog/workbench/index">报告</a></li>
      </ul>
      <ul class="nav nav-sidebar">
        <li class="active"><a href="/ssm-blog/toView/workbench/article/index">文章</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="/Article/checkAll" method="post" >
        ...
        <ol class="breadcrumb">
          <li><a href="/ssm-blog/toView/workbench/article/addArticle">增加文章</a></li>
        </ol>
...
<div class="modal fade user-select" id="areDeveloping" tabindex="-1" role="dialog" aria-labelledby="areDevelopingModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body"> <img src="/ssm-blog/images/baoman/baoman_01.gif" alt="深思熟虑" />
...
<script src="/ssm-blog/bootstrap-3.3.7-dist/js/bootstrap.js"></script>
<script src="/ssm-blog/js/admin-scripts.js"></script>
<script src="/ssm-blog/js/layer-3.5.1/layer.js" type="text/javascript"></script>

<%--导入分页插件--%>
<link type="text/css" href="/ssm-blog/js/bs_pagination/jquery.bs_pagination.min.css" />
<script src="/ssm-blog/js/bs_pagination/en.js"></script>
<script src="/ssm-blog/js/bs_pagination/jquery.bs_pagination.min.js"></script>
<script>
            ...
            for(var i =0 ; i < articles.length; i++){
                ...
                if(article.isOpen == "0"){
                    $('#articleBody').append("<tr>\n" +
                        ...
                        "                <td>\n" +
                        "                    <a href=\"/ssm-blog/toView/workbench/article/updateArticle?id="+article.aid+"\">修改</a> <a onclick=\"deleteById('"+article.aid+"')\" href='javascript:void(0)'>删除</a>&nbsp;\n" +
                    ...
                    $('#articleBody').append("<tr>\n" +
                        ...
                        "                <td>"+article.create_time+"</td>\n" +
                        "                <td>\n" +
                        "                    <a href=\"/ssm-blog/toView/workbench/article/updateArticle?id="+article.aid+"\">修改</a> <a onclick=\"deleteById('"+article.aid+"')\">删除</a>&nbsp;\n" +
    ...
    function deleteById(aid) {
       $.get("/ssm-blog/article/deleteById",{'id':aid},function (data) {
           if(data.ok){
               //删除成功
               layer.alert(data.mess, {icon:6});
               //刷新页面
